    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnTeacherLogIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent startTeacherLogIn = new Intent(getApplicationContext(),TeacherAuth.class);
                finish();
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationCompleted(PhoneAuthCredential phoneAuthCredential) {
                ...
                finish();
                startMainActivity.putExtra("flag","true");
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                           ...
                           startFeedbackActivity.putExtra("flag","true");
                           finish();
